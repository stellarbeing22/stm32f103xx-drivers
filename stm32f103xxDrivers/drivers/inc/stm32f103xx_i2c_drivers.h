...
4.  Driver API Prototypes
    ...
    4.2  I2C init
	4.3  I2C Deinit
	4.4  I2C IRQInterruptConfig
	4.5  I2C IRQPriorityConfig
	4.6  I2C GetFlagStatus
	4.7  I2C PeripheralControl
	4.8  I2C ApplicationEventCallback
	4.9  RCC getPCLK1value
	4.10 RCC getPLLOutputClk
